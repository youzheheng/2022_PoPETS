"""Module with smaller functions used in other modules
"""
#
# Youzhe Heng
#
...
# B6, 26 – Room B2.21, 68159 Mannheim 
# -----------------------------------------------------------------------------
#
# Copyright 2020 University of Mannheim and others.
# All Rights reserved.
#
# -----------------------------------------------------------------------------
# 
...
#
# This program is compiled using python 3.8.5 and Ubuntu LTS 20.04.
#
# =============================================================================
...
def get_memory_usage():
  ...
  try: 
    ...
    return None   # Likely not on a Linux system
